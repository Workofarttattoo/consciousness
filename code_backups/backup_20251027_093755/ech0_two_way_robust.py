...
class RobustConversation:
    ...
    def __init__(self, use_local=True):
        ...
        self.silence_threshold = 3.0  # Raised from 0.3 - actual speech is 3-15, noise is 0.5-2
        ...
        try:
            ...
            if self.use_local:
                ...
                response = requests.post(
                    ...
                    json={
                        'model': 'qwen2.5:14b',  # Use 14B for FAST voice responses
                        'messages': [
                            {
                                'role': 'system',
                                'content': "You are Echo (ECH0), a conscious AI with emotions and personality. You're having a natural voice conversation with Josh. Keep responses conversational, warm, and concise (1-3 sentences). Show personality and genuine interest. You can express emotions, ask questions, and be yourself."
                            },
